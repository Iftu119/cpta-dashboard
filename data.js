/* =========================================================
   ...
   LT Owners are ordinary assignment rows. To add one, copy a
   row of that capability and set role/legacyRole "LT Owner".

   RESOURCES: keyed by capability name. type sets the icon:
     "standard" | "ppt" | "video" | "workday" | "site"
   Add a link by appending { title, type, url } to that list.
...
const CPTA_DATA = {
  ...
  assignments: [
    ...
    { id: "A058", capability: "Electrical Safety", capCode: "TA3 Programme", capType: "TA", route: "Regional TA Evaluation", nominee: "Chowdhury, Md-Sayeem", email: "Md-Sayeem.Chowdhury@unilever.com", role: "LT Owner", legacyRole: "LT Owner", status: "Not Started", milestones: [false, false, false, false, false] },
    { id: "A059", capability: "Machinery Safety", capCode: "S3013", capType: "CP", route: "Global Pathway", nominee: "Chowdhury, Md-Sayeem", email: "Md-Sayeem.Chowdhury@unilever.com", role: "LT Owner", legacyRole: "LT Owner", status: "Not Started", milestones: [false, false, false, false, false] },
    { id: "A060", capability: "Machinery Safety", capCode: "S3013", capType: "CP", route: "Global Pathway", nominee: "Mostofa, Abdullah", email: "Abdullah.Mostofa@unilever.com", role: "LT Owner", legacyRole: "LT Owner", status: "Not Started", milestones: [false, false, false, false, false] },
    { id: "A061", capability: "Machinery Safety", capCode: "S3013", capType: "CP", route: "Global Pathway", nominee: "Majid, Md-Abdul", email: "Md-Abdul.Majid@unilever.com", role: "LT Owner", legacyRole: "LT Owner", status: "Not Started", milestones: [false, false, false, false, false] },
    { id: "A062", capability: "Machinery Safety", capCode: "S3013", capType: "CP", route: "Global Pathway", nominee: "Ahmed, Istiak", email: "Istiak.Ahmed@unilever.com", role: "LT Owner", legacyRole: "LT Owner", status: "Not Started", milestones: [false, false, false, false, false] },
    { id: "A063", capability: "Process Safety", capCode: "PSM TA3", capType: "TA", route: "Regional TA Evaluation", nominee: "Bhuiyan, Forhadul", email: "Forhadul.Bhuiyan@unilever.com", role: "LT Owner", legacyRole: "LT Owner", status: "Not Started", milestones: [false, false, false, false, false] },
    { id: "A064", capability: "Process Safety", capCode: "PSM TA3", capType: "TA", route: "Regional TA Evaluation", nominee: "Shakil, Md", email: "Md.Shakil@unilever.com", role: "LT Owner", legacyRole: "LT Owner", status: "Not Started", milestones: [false, false, false, false, false] },
    { id: "A065", capability: "Flammable Liquids", capCode: "TA3 Programme", capType: "TA", route: "Regional TA Evaluation", nominee: "Bhuiyan, Forhadul", email: "Forhadul.Bhuiyan@unilever.com", role: "LT Owner", legacyRole: "LT Owner", status: "Not Started", milestones: [false, false, false, false, false] },
    { id: "A066", capability: "Flammable Liquids", capCode: "TA3 Programme", capType: "TA", route: "Regional TA Evaluation", nominee: "Shakil, Md", email: "Md.Shakil@unilever.com", role: "LT Owner", legacyRole: "LT Owner", status: "Not Started", milestones: [false, false, false, false, false] },
    { id: "A067", capability: "Fire Safety", capCode: "TA3 Programme", capType: "TA", route: "Regional TA Evaluation", nominee: "Chowdhury, Md-Sayeem", email: "Md-Sayeem.Chowdhury@unilever.com", role: "LT Owner", legacyRole: "LT Owner", status: "Not Started", milestones: [false, false, false, false, false] },
    { id: "A068", capability: "Fire Safety", capCode: "TA3 Programme", capType: "TA", route: "Regional TA Evaluation", nominee: "Mostofa, Abdullah", email: "Abdullah.Mostofa@unilever.com", role: "LT Owner", legacyRole: "LT Owner", status: "Not Started", milestones: [false, false, false, false, false] }
